  ...
  return (
    <section>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-px bg-[#26263A] rounded-md overflow-hidden">
        {coreFindings.map(({ num, title, body }) => (
...
function CompetitiveSnapshotSection() {
  const tableHeaders = ["Company", "ARR", "Pricing", "Sentiment Intel", "Media Mix", "Strategy AI"];
  const scoreMetrics = ["npsAnalytics", "mediaMix", "strategyDepth"] as const;
