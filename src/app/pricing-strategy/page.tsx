...
function PricingRationaleSection() {
  return (
    <section>
      <SectionHeader
        index="04"
      ...
      <div className="space-y-0">
        {rationaleItems.map(({ n, title, desc }) => (
...
function StrategicRecommendationSection() {
  return (
        ...
        <div className="max-w-3xl space-y-5">
          ...
          <div className="pt-5 border-t border-[#26263A]">
            ...
            <div className="space-y-3">
              {pricingRisks.map((risk, i) => (
                <div key={risk.slice(0, 30)} className="flex gap-3">
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-20">
        ...
        <PricingChartsSection />
        <PricingRationaleSection />
        <StrategicRecommendationSection />
      </div>
    </div>
  );
}
