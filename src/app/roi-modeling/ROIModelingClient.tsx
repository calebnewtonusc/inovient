...
export default function ROIModelingClient() {
        ...
        <section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
            ...
            <div className="card p-6 space-y-6">
              ...
              {/* Tier selector */}
              <div>
                <label htmlFor="tier-selector" className="text-xs text-[#6A6A90] block mb-2">Select Tier</label>
                <div id="tier-selector" className="grid grid-cols-3 gap-2">
